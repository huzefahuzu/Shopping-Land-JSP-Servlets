...
<body>
	...
	<div id="page-content">
		...
		<p align="left">
			<a href="ccalsl"><button type="button" class="btn btn-primary">Back</button></a>
		</p>

		<form id="form-validation" action="ccaisc" method="get"
			...
			<div class="form-box-content">
				...
				<div class="control-group">
					<label class="control-label" for="val_comp">State Name *</label>
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-user"></i></span> <input
								type="text" id="val_comp" name="stateName" tabindex="1"
								value="${state}">
