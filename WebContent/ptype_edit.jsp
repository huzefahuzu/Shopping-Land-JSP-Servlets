...
<body>
	<div id="page-container">
		...
		<div id="page-content">
			...
			<p align="left">
				<a href="ccptl"><button type="button" class="btn btn-primary">Back</button></a>
			</p>

			<form id="form-validation" action="ccpc" method="post"
				class="form-horizontal form-box remove-margin">

				<h4 class="form-box-header">Edit Product Type</h4>
						...
						<div class="controls">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-user"></i></span> <input
									type="text" id="val_comp" name="pType" tabindex="1" value="">
							</div>
						</div>
					</div>

					<p>${requestScope.pType}</p>
