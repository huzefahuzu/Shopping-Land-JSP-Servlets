...
<body>
	<div id="page-container">
		...
		<div id="page-content">
			...
			<p align="left">
				<a href="CategoryList"><button type="button"
						class="btn btn-primary">Back</button></a>
			</p>

			<form id="form-validation" action="ccpcc" method="get"
				class="form-horizontal form-box remove-margin">

				<h4 class="form-box-header">Add New Category</h4>
						...
						<div class="controls">
							<div class="input-prepend">
								...
								<span class="add-on"><i class="icon-user"></i></span> <select
									...
									<c:forEach var="typeList" items="${typeDropdownList}">
						...
						<div class="controls">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-user"></i></span> <input
									type="text" id="val_comp" name="category_name" tabindex="1"
									value="">
							</div>
						</div>
					</div>
