			...
			<div id="inner-container">
				...
				<div id="page-content">
					...
					<form id="form-validation" action="" method="post"
						...
						<h4 class="form-box-header">Add New Product</h4>
						...
						<div class="form-box-content">
							...
							<div class="control-group">
								<label class="control-label" for="val_comp">Product Type
									*</label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label" for="val_comp">Category
									Name *</label>
								<div class="controls">
									<div class="input-prepend">
										<span class="add-on"><i class="icon-user"></i></span> <select>
							...
							<div class="control-group">
								<label class="control-label" for="val_comp">Brand *</label>
								<div class="controls">
									<div class="input-prepend">
										<span class="add-on"><i class="icon-user"></i></span> <select>
											<option>shoes</option>
							...
							<div class="control-group">
								<label class="control-label" for="val_comp">Product Name
									*</label>
								<div class="controls">
									<div class="input-prepend">
							...
							<div class="control-group">
								<label class="control-label" for="val_comp">Is Size and Color Applicable ? </label>
								<div class="controls">
									<div class="input-prepend">
							...
							<div class="form-actions">
								<button type="reset" class="btn btn-danger"
									onClick="window.location.href='customer_show.html'"
									tabindex="9">
