	...
	<div id="page-container">
		...
		<div id="page-content">
			...
			<h3 class="page-header page-header-top">
				Size <small> Master</small>
			</h3>

			<p align="right">
				<a href="ccalsdl"><button type="button" class="btn btn-primary">Add
						Size Details</button></a>
			</p>
			...
			<table id="example-datatables"
				...
				<thead>
					<tr>
						...
						<th><i class="icon-user"></i> Size</th>
				...
				<tbody>
					<%
						List<SizeBean> sizeList=(ArrayList)request.getAttribute("sizeList");
														SizeBean sb;
														if(sizeList!=null){
					...
					<tr>
						...
						<td><a href="javascript:void(0)"><%=sb.getSize()%></a></td>
						<td class="span1">
							<div class="btn-group">
