...
<body>
	<div id="page-container">
		...
		<div id="inner-container">
			...
			<form action="ccaddc" method="get">
				<div id="page-content">

					<h3 class="page-header page-header-top">
						Country <small> Master</small>
					</h3>

					<p align="right">
						<a href="country_add.jsp"><button type="button"
								class="btn btn-primary">Add Country</button></a>
					</p>
					<p>
							...
							<c:forEach items="${countryList}" var="countryBean">
								<tr>
									...
									<td class="span1 hidden-phone"><input type="checkbox"
										...
										name="chkDeleteCountry" value="${countryBean.country_id}" /></td>

									<td><a href="javascript:void(0)">${countryBean.country_name}</a></td>
