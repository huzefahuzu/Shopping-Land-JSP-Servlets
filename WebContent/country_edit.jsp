	...
	<div id="page-container">
		...
		<div id="inner-container">
			...
			<div id="page-content">
				...
				<p align="left">
					<a href="CountryList"><button type="button"
							class="btn btn-primary">Back</button></a>
				</p>

				<form id="form-validation" action="CountryController" method="get"
					class="form-horizontal form-box remove-margin">

					<h4 class="form-box-header">Edit Country</h4>
					...
					<div class="form-box-content">
						...
						<div class="control-group">
							<label class="control-label" for="val_comp">Country Name
								*</label>
							<div class="controls">
								<div class="input-prepend">
									<span class="add-on"><i class="icon-user"></i></span> <input
										type="text" id="val_comp" name="country_name" tabindex="1"
										value="">
