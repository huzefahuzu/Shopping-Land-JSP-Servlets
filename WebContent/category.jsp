...
<body>
	...
	<div id="page-container">
		...
		<form action="DeleteProductCategory" method="get">
			<div id="page-content">

				<h3 class="page-header page-header-top">
					Categories <small> Master</small>
				</h3>

				<p align="right">
					<a href="cdl"><button type="button" class="btn btn-primary">Add
							Category</button></a>
				</p>
				<p>
						...
						<c:forEach items="${categorylist}" var="categoryBean">
							<tr>
								...
								<td class="span1 hidden-phone"><input type="checkbox"
									...
									name="chkDeleteCategory" value="${categoryBean.category_id}" /></td>

								<td><a href="javascript:void(0)">${categoryBean.p_type}</a></td>
								<td><a href="javascript:void(0)">${categoryBean.category_name}</a></td>
								<td class="span1">
									<div class="btn-group">
