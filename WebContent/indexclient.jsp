    ...
    <div class="container">
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#pages">Types</a>
                    <ul class="dropdown-menu" role="menu">
...
<!-- ============================================================= LOGO : END ============================================================= -->		</div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i> (+91) 90 33 89 11 86
    </div>
    <div class="contact inline">
        <i class="fa fa-envelope"></i> contact@<span class="le-color">kraitsolutions.com</span>
    </div>
</div><!-- /.contact-row -->
<!-- ============================================================= SEARCH AREA ============================================================= -->
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        <ul class="nav">
            <li class="dropdown menu-item">
            	<%
							List<TypeBean> tbl=(ArrayList)request.getAttribute("typeList"); 
											
										for(int i=0;i<tbl.size();i++){
											TypeBean tb=(TypeBean)tbl.get(i);
						%>
						
						
                <a href="ListTypeController" class="dropdown-toggle" data-toggle="dropdown"><%=tb.getpType() %></a>
                  <%} %>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="">beats studio headphones official one</a>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="">playstasion 4 with four games and pad</a>
                                </div>
                                <div class="brand">acer</div>
                            </div>
                            <div class="prices">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="">EOS rebel t5i DSLR Camera with 18-55mm IS STM lens</a>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="">fitbit zip wireless activity tracker - lime</a>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            ...
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                                    <a href="">netbook acer travelMate b113-E-10072</a>
                                </div>
                                <div class="brand">acer</div>
                            </div>
                            <div class="prices">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div class="body">
                        <div class="label-discount clear"></div>
                        <div class="title">
                            <a href="">CPU intel core i5-4670k 3.4GHz BOX B82-12-122-41</a>
                        </div>
                        <div class="brand">sony</div>
                    </div>
                    <div class="prices text-right">
                        <div class="price-current inline">$1199.00</div>
                        <a href="" class="le-button big inline">add to cart</a>
                    </div>
                </div><!-- /.product-item-holder -->
            </div><!-- /.col -->
			...
			<div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
				<div class="no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="body">
							<div class="title">
								<a href="">LC-70UD1U 70" class aquos 4K ultra HD</a>
							</div>
				...
				<div class="no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="body">
							<div class="title">
								<a href="">cinemizer OLED 3D virtual reality TV Video</a>
							</div>
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="body">
							<div class="title">
								<a href="">s2340T23" full HD multi-Touch Monitor</a>
							</div>
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="body">
							<div class="title">
								<a href="">kardon BDS 7772/120 integrated 3D</a>
							</div>
				...
				<div class=" no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
						...
						<div class="body">
							<div class="title">
								<a href="">iPod touch 5th generation,64GB, blue</a>
							</div>
...
<!-- ============================================================= LINKS FOOTER : END ============================================================= -->            </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="">krait solutions</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
