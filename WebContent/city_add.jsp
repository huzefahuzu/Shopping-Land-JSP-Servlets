...
<script src="js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
  <script type='text/javascript' src='/Shoppioing__Expo/dwr/interface/StateDao.js'></script>
...
<body>
	...
	<div id="page-content">
		...
		<p align="left">
			<a href="ccalc"><button type="button" class="btn btn-primary">Back</button></a>
		</p>

		<form id="form-validation" action="ccaicc" method="get"
			class="form-horizontal form-box remove-margin">

			<h4 class="form-box-header">Add New State</h4>
			...
			<div class="form-box-content">
					...
					<div class="controls">
						<div class="input-prepend">
							...
							<span class="add-on"><i class="icon-user"></i></span> <select
								name="countryId" id="countryId" onchange="getReply(this.value);">
								<option value=" ">-----SELECT COUNTRY-----</option>
								<c:forEach var="countryList" items="${countryDropdownList}">
				...
				<div class="control-group">
					<label class="control-label" for="val_comp">City Name *</label>
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-user"></i></span> <input
								type="text" id="cityId" name="cityName" tabindex="1"
								value="${cityValue}">
