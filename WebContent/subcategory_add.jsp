...
<script type="text/javascript">
	function getReply(typeId) {
		...
		dwr.util.removeAllOptions("category1");
		...
		if (typeId == '') {
			...
			dwr.util.addOptions("category1", data, "category_id",
					"category_name");
		} else {
			alert("here1");
			alert("typeId");
...
<body>
	<div id="page-container">
		...
		<div id="page-content">
			...
			<p align="left">
				<a href="ccalscl"><button type="button" class="btn btn-primary">Back</button></a>
			</p>

			<form id="form-validation" action="ccaipscc" method="get"
				class="form-horizontal form-box remove-margin">

				<h4 class="form-box-header">Add New Sub-Category</h4>
						...
						<div class="controls">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-user"></i></span> <select
									name="typeId" id="typeId" onchange="getReply(this.value);">
									<option value="-1">--- Select Type ---</option>

									<c:forEach var="typeDropDown" items="${typeDropdownList}">
										<option value="${typeDropDown.pType_Id}">${typeDropDown.pType}</option>
						...
						<div class="controls">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-user"></i></span> <input
									type="text" id="val_comp" name="subCategory_Name" tabindex="1"
									value="">
							</div>
						</div>
					</div>
