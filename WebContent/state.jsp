		...
		<div id="inner-container">
			...
			<form action="ccadds" method="get">
				...
				<div id="page-content">
					...
					<p align="right">
						<a href="ccalcdl"><button type="button"
								class="btn btn-primary">Add State</button></a>
					</p>
					<p>
					...
					<table id="example-datatables"
						...
						<tbody>
							...
							<c:forEach var="stateBean" items="${stateList}">
								<tr>

									<td class="span1 hidden-phone"><input type="checkbox"
										class="checkBoxClass" id="Checkbox1"
										style="margin-left: 15px; margin-bottom: 5px;"
										name="chkDeleteState" value="${stateBean.stateId}" /></td>

									<td><a href="javascript:void(0)">${stateBean.stateName}</a></td>
									<td class="span1">
										<div class="btn-group">
