...
<body>
	...
	<div id="page-container">
		...
		<form action="DeleteProductType" method="get">
			<div id="page-content">

				<h3 class="page-header page-header-top">
					ProductType <small> Master</small>
				</h3>

				<p align="right">
					<a href="ptype_add.jsp"><button type="button"
							class="btn btn-primary">Add Type</button></a>
				...
				<table id="example-datatables"
					...
					<thead>
						<tr>
							...
							<th><i class="icon-user"></i> Type Name</th>
					...
					<tbody>
						...
						<c:forEach var="typeBean" items="${list}">
							<tr>

								<td class="span1 hidden-phone"><input type="checkbox"
									class="checkBoxClass" id="Checkbox1"
									style="margin-left: 15px; margin-bottom: 5px;" name="chkDelete"
									value="${typeBean.pType_Id}" /></td>
								</td>
								<td><a href="javascript:void(0)">${typeBean.pType}</a></td>
								<td class="span1">
									<div class="btn-group">
