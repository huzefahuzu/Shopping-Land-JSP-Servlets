	...
	<div id="page-container">
		...
		<div id="page-content">
			...
			<h3 class="page-header page-header-top">
				Color <small> Master</small>
			</h3>

			<p align="right">
				<a href="color_add.jsp"><button type="button"
						class="btn btn-primary">Add Color Details</button></a>
			</p>
			...
			<table id="example-datatables"
				...
				<thead>
					<tr>
						...
						<th><i class="icon-user"></i> Color Name</th>
						<th class="hidden-phone hidden-tablet"><i
							class="icon-envelope-alt"></i> Contact No</th>
				...
				<tbody>
					...
					<script>
						...
						<td class="span1 hidden-phone"><input type="checkbox" class="checkBoxClass" id="Checkbox1" style="margin-left: 15px;"/></td>
