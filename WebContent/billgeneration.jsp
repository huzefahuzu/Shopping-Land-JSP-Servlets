...
<div class="jquery-script-clear"></div>
		...
		<h1 style="text-align: center;">Order Bill </h1>
 		...
 		<table border="1">
 			...
 			<th style="padding-right: 30px">Product Details</th>
 			<th style="padding-right: 30px">Quantity</th>
 			<th style="padding-right: 30px">Price/Unit (Rs.)</th>
 			<th style="padding-right: 30px">Confirmed Quantity</th>
 			<th style="padding-right: 30px">Sub Total</th>
 			<th style="padding-right: 30px">Address</th>
