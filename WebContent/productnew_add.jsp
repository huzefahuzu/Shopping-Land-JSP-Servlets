...
<body>
	<div id="page-container">
		...
		<div id="page-content">
			...
			<p align="left">
				<a href="productnew.jsp"><button type="button"
							...
							<div id="wizard" class="swMain">
								<ul>
									<li><a href="#step-1"> <span class="stepNumber">1</span>
											<span class="stepDesc"> Step 1<br /> <small>Product
													Details</small>
										</span>
									</a></li>
									<li><a href="#step-2"> <span class="stepNumber">2</span>
											<span class="stepDesc"> Step 2<br /> <small>Color
													Details</small>
										</span>
									</a></li>
									<li><a href="#step-3"> <span class="stepNumber">3</span>
											<span class="stepDesc"> Step 3<br /> <small>Size
													Details</small>
										</span>
									</a></li>
									<li><a href="#step-4"> <span class="stepNumber">4</span>
											<span class="stepDesc"> Step 4<br /> <small>Final
													Step</small>
										</span>
									</a></li>
								</ul>
								<div id="step-1" style="overflow: scroll">
									...
									<div class="form-box-content">
										...
										<div class="control-group">
											<label class="control-label" for="val_number">Brand</label>
											<div class="controls">
												<div class="input-prepend">
													<span class="add-on"><i class="icon-asterisk"></i></span> <select>
														<option>Footwears</option>
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-prepend">
													...
													<input type="file" multiple id="val_comp" name="val_comp"
														tabindex="1" value="">
												</div>
											</div>
										</div>
										...
										<div class="control-group">
											<label class="control-label" for="val_comp">Is Size
												Applicable ? </label>
											<div class="controls">
												<div class="input-prepend">

													<input type="checkbox" id="val_comp" name="val_comp"
														tabindex="1" value="">
												</div>
											</div>
										</div>
										...
										<div class="control-group">
											<label class="control-label" for="val_comp">Is Color
												Applicable ? </label>
											<div class="controls">
												<div class="input-prepend">
											...
											<div class="controls">
												<div class="input-prepend">
													...
													<select id="example-select-multiple"
														name="example-select-multiple" class="form-control"
														multiple="">
														<option>html</option>
														<option>css</option>
