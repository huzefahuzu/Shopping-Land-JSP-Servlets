...
<body>
	...
	<%if (request.getAttribute("forgainKey") != null) {%>
		alert("You're the proposal to delete the data in the Category table is used as the Foreignkey.");
	<%}%>
	...
	<div id="page-container">
		...
		<!------------------------------------------------------ Main Divison ------------------------------------------------------------>
		<form action="ccaddps" method="get">

			<div id="page-content">

				<h3 class="page-header page-header-top">
					Subcategory <small> Master</small>
				</h3>

				<p align="right">
					<a href="SubCategoryDropdown"><button type="button"
							class="btn btn-primary">Add Sub-Category</button></a>
				</p>
				<p>
				...
				<table id="example-datatables"
					...
					<thead>
						<tr>
							...
							<th><i class="icon-user"></i> Category Name</th>

							<th><i class="icon-user"></i> Subcategory Name</th>
					...
					<tbody>
						...
						<c:forEach items="${subCategoryList}" var="subCategoryBean">
							<tr>
								<td class="span1 hidden-phone"><input type="checkbox"
									class="checkBoxClass" id="Checkbox1"
									style="margin-left: 15px; margin-bottom: 5px;"
									name="chkDeleteSubCategory"
									value="${subCategoryBean.subcategory_Id}" /></td>


								<td><a href="javascript:void(0)">${subCategoryBean.p_type}</a></td>
								<td><a href="javascript:void(0)">${subCategoryBean.category}</a></td>
								<td><a href="javascript:void(0)">${subCategoryBean.subCategory}</a></td>
								<td class="span1">
									<div class="btn-group">
										<a data-toggle="tooltip" title="View" class="btn btn-warning"
											data-reveal-id="myDtModal"><i class="icon-list-ul"></i></a> <a
											href="#" data-toggle="tooltip" title="Edit"
